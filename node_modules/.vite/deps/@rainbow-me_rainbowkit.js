...
import {
  ...
  withRetry,
  withTimeout
} from "./chunk-XIF5LUGY.js";
import {
  useQuery
} from "./chunk-HBMSL3B2.js";
import {
  BaseError,
...
import {
  mainnet
} from "./chunk-PQ6DWWIW.js";
import "./chunk-MDT7WR2Y.js";
import {
  ...
  isAddress,
  numberToHex
} from "./chunk-VHISS7D7.js";
import {
  formatAbi,
  formatAbiItem,
  parseAbi
} from "./chunk-AVNE4FUI.js";
import "./chunk-JUAO2N6C.js";
...
function fromHex6(hex, group) {
  return fromBytes6(toBytes2(hex), group);
}
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createCoinbaseWalletSDK } = await import("./dist-NEYUFGLA.js");
    ...
    async getProvider() {
      ...
      if (!walletProvider) {
        const CoinbaseWalletSDK = await (async () => {
          const { default: SDK } = await import("./dist-75QKHX4J.js");
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      ...
      if (!isIframe)
        return;
      if (!provider_) {
        const { default: SDK } = await import("./esm-IWLWABPO.js");
        ...
        const SafeAppProvider = await (async () => {
          const Provider = await import("./dist-XOHKLYO7.js");
    ...
    async getProvider({ chainId } = {}) {
      ...
      async function initProvider() {
        ...
        if (!optionalChains.length)
          return;
        const { EthereumProvider } = await import("./index.es-NGBBEUAU.js");
